              ...
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                <div class="mdc-card">
                  <div class="d-flex justify-content-between">
                    <h4 class="card-title mb-0">Candidate Listing</h4>
                  </div>
                  <div class="d-block d-sm-flex justify-content-between align-items-center">
                      <h5 class="card-sub-title mb-2 mb-sm-0">100 records found</h5>
                  </div>
                    <div class="custom-data-table mt-4">
                      <table id="jobListing" class="display" style="width:100%">
                        ...
                        <tbody>
                        <?php foreach($objectjda->findAllCandidatesInfo() as $candidateInfoData ) { ?>
                            <tr>
                                <td></td>
                                <td><?= $candidateInfoData['first_name'] ?></td>
                                <td><?= $candidateInfoData['last_name'] ?></td>
                                <td><?= $candidateInfoData['email'] ?></td>
                                <td><?= $candidateInfoData['phone'] ?></td>
                                <td><?= $candidateInfoData['candidate_dob'] ?></td>
                                <td>
