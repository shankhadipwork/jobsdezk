...
if(isset($_POST['login_super_recruiter']))
{   
$msg=$objectjdsr->superRecuiterLogin();
} 
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <form action="" method="post">
            <div class="">
                <div class="">
                    ...
                    <div class="row">
                        <div class="mx-auto">
                            <input type="submit" name="login_super_recruiter" class="btn-custom btn-save" value="Submit">
                        </div>                               
                    </div>
                    <div class="row">    
                        <div class="mx-auto terms-link">
                            Are you a "Sub-Recruiter"? Please <a href="sub-recruiter-login">Login</a> here.
                        </div>                                
                    </div>
                </div>                              
            </div>
